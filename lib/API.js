...
(function() {
  var API, Serializer, append_slash, callable, debug, merge, querystring, ref, request,
  ...
  ref = require('./utils'), callable = ref.callable, append_slash = ref.append_slash, merge = ref.merge;
  ...
  API = callable((function() {
    ...
    _Class.prototype._construct_request = function(method, kwargs) {
      var base, key, ref1, request_options, value;
      request_options = {
        url: this.base_url,
        method: method,
        headers: {}
