...
(function() {
  var API, Serializer, append_slash, callable, debug, querystring, ref, request,
  ...
  ref = require('./utils'), callable = ref.callable, append_slash = ref.append_slash;
  ...
  API = callable((function() {
    ...
    _Class.prototype._request = function(method, kwargs, fn) {
      var key, ref1, req, request_options, value;
      request_options = {
        url: this.base_url,
        method: method,
        headers: {
